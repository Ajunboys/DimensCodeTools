...
public class DimensCodeTools {
	...
	public static void startScanForFragment(Fragment fragment){
		startScanWithFeatureForFragment(fragment,ScanParams.QRCODE_FEATURES);
	}
	...
	private static void startScanWithFeatureForFragment(Fragment fragment,
			int feature) {
	...
	public static void starScanWithBarSizeForFragment(Fragment fragment, int barWidth,
			int barHeight) {
		Intent intent = new Intent(fragment.getActivity(), CaptureActivity.class);
		intent.putExtra(ScanParams.WHICH, ScanParams.BARCODE_FEATURES);
		intent.putExtra(ScanParams.BARCODE_WIDTH_PIX, barWidth);
	...
	public static void starScanWithQRSizeForFragment(Fragment fragment, int qrWidth,
			int qrHeight) {
		Intent intent = new Intent(fragment.getActivity(), CaptureActivity.class);
		intent.putExtra(ScanParams.WHICH, ScanParams.QRCODE_FEATURES);
		intent.putExtra(ScanParams.QRCODE_WIDTH_PIX, qrWidth);
	...
	public static void startScan(Fragment fragment, int feature, int barWidth,
			int barHeight, int qrWidth, int qrHeight) {
		Intent intent = new Intent(fragment.getActivity(), CaptureActivity.class);
		intent.putExtra(ScanParams.WHICH, feature);
		intent.putExtra(ScanParams.QRCODE_WIDTH_PIX, qrWidth);
